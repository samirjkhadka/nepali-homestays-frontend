...
import { Users, FileCheck, Calendar, CreditCard, BarChart3, FileText, Youtube, X, Download, Home, MessageSquare, Bell, Activity, AlertCircle, Mail, MousePointer, Plus, RefreshCw, Newspaper, ChevronUp, ChevronDown } from 'lucide-react';
...
import CorporatesSection from './sections/CorporatesSection';
...
export default function AdminDashboard() {
  ...
  // Bumped when another section changes the bookings list, so this one refetches
  // without that section reaching into its state.
  ...
  }, [tab, adminBookingsStatus, adminBookingsRefresh]);
  ...
  return (
    <div>
      ...
      {tab === 'corporates' && (
        <CorporatesSection
          users={users}
          onBookingCreated={() => setAdminBookingsRefresh((n: number) => n + 1)}
        />
      )}
